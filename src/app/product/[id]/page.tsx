...
//         email: string;
//         contact: string;
//         address: string;  // Add address to prefill
//     };
//     theme: {
//         color: string;
//     };
...
//         email: '',
//         contact: '',
//         address: '',  // Add address to userDetails
//     });
//     const [razorpayLoaded, setRazorpayLoaded] = useState(false);
...
//                     email: userDetails.email,
//                     contact: userDetails.contact,
//                     address: userDetails.address,  // Include address in prefill
//                 },
//                 theme: {
//                     color: '#3399cc',
//                 },
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const razorpayOptions: RazorpayOptions = {
                ...
                currency: 'INR',
                name: 'VENDALYN',
                description: `${product.name}\nAddress: ${userDetails.address}`,  // Send address in the description
                image: '/favicon.png',
                order_id: order.id,
                handler: async (response: { razorpay_payment_id: string; razorpay_signature: string }) => {
                    const verifyResponse = await fetch('/api/verifyOrder', {
