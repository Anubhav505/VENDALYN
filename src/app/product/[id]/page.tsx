...
export default function ProductPage() {
    ...
    const handlePayment = async () => {
        if (!userDetails.name || !userDetails.email || !userDetails.contact || !userDetails.address || !selectedSize) {
            alert('Please fill in all the details and select a size before proceeding to payment.');
            return;
        }
        ...
        try {
            ...
            const razorpayOptions: RazorpayOptions = {
                ...
                currency: 'INR',
                name: 'VENDALYN',
                description: `${product.name}\nAddress: ${userDetails.address}\nSize: ${selectedSize}`, // Include size in description
                image: '/favicon.png',
                order_id: order.id,
