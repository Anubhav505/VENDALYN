...
const page = () => {
  return (
    <div className='flex justify-center py-12'>
      <div className='w-[60%] flex flex-col gap-6 text-justify text-sm'>
        <h1 className='text-5xl text-center'>TERMS AND CONDITIONS</h1>
        <div>
          <h1 className=' uppercase ' >1. Acceptance of Terms</h1>
        ...
        <div>
          <h1 className=' uppercase ' >2. Changes to Terms</h1>
        ...
        <div>
          <h1 className=' uppercase ' >3. Use of Website</h1>
        ...
        <div>
          <h1 className=' uppercase '>4. Product Information</h1>
        ...
        <div>
          <h1 className=' uppercase '>5. Orders and Payments</h1>
        ...
        <div>
          <h1 className=' uppercase ' >6. Shipping and Delivery</h1>
        ...
        <div>
          <h1 className=' uppercase ' >7. Returns and Refunds</h1>
        ...
        <div>
          <h1 className=' uppercase ' >8. Intellectual Property</h1>
        ...
        <div>
          <h1 className=' uppercase ' >9. Limitation of Liability</h1>
        ...
        <div>
          <h1 className=' uppercase ' >10. User Conduct</h1>
        ...
        <div>
          <h1 className=' uppercase ' >11. Third-Party Links</h1>
        ...
        <div>
          <h1 className='text-sm uppercase' >12. Governing Law</h1>
        ...
        <div>
          <h1 className='text-sm uppercase' >13. Contact Information</h1>
          <p>If there are any questions regarding this privacy policy you may contact us using the information below:</p>

          <p><b>hello@vendalyn.com</b></p>
        </div>
      </div>
    </div>
  )
