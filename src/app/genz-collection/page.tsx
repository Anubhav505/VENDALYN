...
const Products = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            const filtered = data.filter((product: Product) => product.category === "genz-collection");
    ...
    return (
        <div className="min-h-screen grid grid-cols-2 md:grid-cols-3 gap-4 my-2 mb-12 px-2 ">
            {loading ? (
