...
export default function footer() {
  return (
    <div className="h-[55vh] sm:h-screen bg-black w-full flex flex-col text-white z-[51]">
      <div className="h-1/2 flex gap-4 sm:flex-row p-4 sm:p-10">
        <div className="sm:w-1/2 hidden sm:block">
          <h1 className="V text-white sm:text-[1.5vw] font-normal">Where Quality Meets Confidence.</h1>
        </div>
        <div className="flex flex-row justify-between w-full gap-4 sm:gap-0 sm:w-1/2 text-sm font-medium">
          <div className="text-2xl sm:font-medium sm:text-sm font-light sm:w-1/2 flex flex-col gap-1">
            <Link href={"/"}>
